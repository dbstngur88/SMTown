        ...
        public void onBindViewHolder(@NonNull RestaurantAdapter.ViewHolder holder, final int position) {
            ...
            holder.maps.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("y", Double.parseDouble(arrayRestaurant.get(position).getLatitude()));     //경도
                    intent.putExtra("x", Double.parseDouble(arrayRestaurant.get(position).getLongitude()));      //위도
                    intent.putExtra("place_name", arrayRestaurant.get(position).getName());
